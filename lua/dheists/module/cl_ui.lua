...
timer.Simple( 0, function()
    ...
    function SKIN:PaintWindowCloseButton( panel, w, h )
        draw.SimpleText("✕", SKIN.fontFrame, w / 1.5, h / 2.3, panel:IsDown() and Color( 125, 125, 125, 255 ) or panel:IsHovered() and Color( 185, 185, 185, 255 ) or color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
    end

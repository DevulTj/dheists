...
function dHeists.DrawAction()
	...
	local timeRemainingText = actionData.ActionTimeRemainingTextPhrase and dL( actionData.ActionTimeRemainingTextPhrase ) or actionData.ActionTimeRemainingText or "TIME REMAINING"

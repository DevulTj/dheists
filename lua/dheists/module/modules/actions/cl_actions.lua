...
function dHeists.DrawAction()
	...
	local timeRemainingText = actionData.ActionTimeRemainingTextPhrase and L( actionData.ActionTimeRemainingTextPhrase ) or actionData.ActionTimeRemainingText or "TIME REMAINING"
